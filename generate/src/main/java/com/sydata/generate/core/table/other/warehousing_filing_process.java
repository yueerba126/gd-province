package com.sydata.generate.core.table.other;
 ...
 */
public class warehousing_filing_process {
    ...
    // 在此处添加，分页页面的查询参数
    public static final String PAGE_PARAM_ADD = "id,companyId,shjg,updateTime";
    ...
    static {
        ...
        VO_ADD_LIST.add(new PropertyInfo("shjg","DataBindDict","filing_shjg"));
    }
    // 确定该表的每条数据唯一的联合键
    public static final String PRIMARY_KEY_ADD = "id";
    // 是否从表 是否有主表id，没有不填
    public static final String MAIN_TABLE_ID_ADD = "companyId";
    // 导出Excel要排除的字段
    public static final String EXCEL_EXCLUDE = "companyId,shjg"
            + ",id," + ENTITY_EXCLUDE;
}
