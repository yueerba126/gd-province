...
public class TableUtil {
    ...
    public static final String SRC_MAIN_RESOURCES_PATH = "/src/main/resources/templates/table/";
    ...
    public static BasisInfo generateBasisInfo() throws SQLException {
        ...
        basisInfo.setStartDate(DateUtil.format(DateUtil.nextWeek(),"yyyy-MM-dd"));
        basisInfo.setEndDate(DateUtil.format(new Date(),"yyyy-MM-dd"));
        basisInfo.setStartTime(DateUtil.format(DateUtil.nextWeek(),"yyyy-MM-dd HH:mm:ss"));
        basisInfo.setEndTime(DateUtil.format(new Date(),"yyyy-MM-dd HH:mm:ss"));
