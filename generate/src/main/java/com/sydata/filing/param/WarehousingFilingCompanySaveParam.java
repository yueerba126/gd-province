...
public class WarehousingFilingCompanySaveParam implements Serializable {
    ...
    @NotBlank(message = "zhId 不容许为空")
    @ApiModelProperty(name = "zhId" , value = "库软件租户ID" , example = "库软件租户ID")
    @Size(min = 0, max = 18, message = "库软件租户ID 长度必须在 0 - 18 之间")
    private String zhId;

    @ApiModelProperty(name = "kdId" , value = "库软件库点ID" , example = "库软件库点ID")
    @Size(min = 0, max = 20, message = "库软件库点ID 长度必须在 0 - 20 之间")
    private String kdId;
    ...
    @ApiModelProperty(name = "shsj" , value = "审核时间" , example = "2023-07-02 10:40:54")
    @JsonFormat(shape = JsonFormat.Shape.STRING, pattern="yyyy-MM-dd HH:mm:ss")
    private LocalDateTime shsj;

    @ApiModelProperty(name = "barq" , value = "备案日期" , example = "2023-07-02")
    ...
    @ApiModelProperty(name = "zcsj" , value = "注册时间" , example = "2023-07-02")
    @JsonFormat(shape = JsonFormat.Shape.STRING, pattern="yyyy-MM-dd")
    ...
    @ApiModelProperty(name = "zhgxsj" , value = "最后更新时间" , example = "LocalDateTime" ,hidden = true)
    @JsonFormat(shape = JsonFormat.Shape.STRING, pattern="yyyy-MM-dd HH:mm:ss")
    ...
    @ApiModelProperty(name = "regionId" , value = "行政区域ID" , example = "String" ,hidden = true)
    @Size(min = 0, max = 10, message = "行政区域ID 长度必须在 0 - 10 之间")
    private String regionId;

    @ApiModelProperty(name = "countryId" , value = "国ID" , example = "String" ,hidden = true)
    @Size(min = 0, max = 10, message = "国ID 长度必须在 0 - 10 之间")
    private String countryId;

    @ApiModelProperty(name = "provinceId" , value = "省ID" , example = "String" ,hidden = true)
    @Size(min = 0, max = 10, message = "省ID 长度必须在 0 - 10 之间")
    private String provinceId;

    @ApiModelProperty(name = "cityId" , value = "市ID" , example = "String" ,hidden = true)
    @Size(min = 0, max = 10, message = "市ID 长度必须在 0 - 10 之间")
    private String cityId;

    @ApiModelProperty(name = "areaId" , value = "区ID" , example = "String" ,hidden = true)
    @Size(min = 0, max = 10, message = "区ID 长度必须在 0 - 10 之间")
    private String areaId;

    @ApiModelProperty(name = "enterpriseId" , value = "企业ID" , example = "String" ,hidden = true)
    @Size(min = 0, max = 18, message = "企业ID 长度必须在 0 - 18 之间")
    private String enterpriseId;

    @ApiModelProperty(name = "stockHouseId" , value = "库区ID" , example = "String" ,hidden = true)
    @Size(min = 0, max = 21, message = "库区ID 长度必须在 0 - 21 之间")
