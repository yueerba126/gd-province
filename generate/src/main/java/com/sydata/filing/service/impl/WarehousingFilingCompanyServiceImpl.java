...
public class WarehousingFilingCompanyServiceImpl extends ServiceImpl<WarehousingFilingCompanyMapper, WarehousingFilingCompany> implements IWarehousingFilingCompanyService  {
    ...
    public Boolean updateOrSaveByUnx(WarehousingFilingCompanySaveParam saveParam) {
        ...
        if (ObjectUtils.isNotEmpty(unx)) {
            return super.lambdaUpdate()
                ...
                .set(ObjectUtils.isNotEmpty(saveParam.getZhId()),WarehousingFilingCompany::getZhId,saveParam.getZhId())
                .set(ObjectUtils.isNotEmpty(saveParam.getKdId()),WarehousingFilingCompany::getKdId,saveParam.getKdId())
