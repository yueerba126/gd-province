...
public interface IWarehousingFilingDeviceService extends IService<WarehousingFilingDevice> {
    ...
    * @return 列表
    */
    List<WarehousingFilingDeviceVo> listByMainId(String stockId);
    ...
    * @return 列表
    */
    Boolean deleteByMainId(String stockId);
    ...
    * @return 列表
    */
    List<WarehousingFilingDeviceSaveParam> listByMainIdWithSaveParam(String stockId);
    ...
    * @return 列表
    */
    List<WarehousingFilingDeviceVo> listByMainIdWithHistory(String stockId);
    ...
    * @return 列表
    */
    List<WarehousingFilingDeviceSaveParam> listByMainIdWithSaveParamWithHistory(String stockId);
