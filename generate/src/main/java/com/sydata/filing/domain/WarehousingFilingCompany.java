...
public class WarehousingFilingCompany implements Serializable {
    ...
    @ApiModelProperty(name = "zhId" , value = "库软件租户ID")
    private String zhId;

    @ApiModelProperty(name = "kdId" , value = "库软件库点ID")
    private String kdId;
    ...
    @ApiModelProperty(name = "regionId" , value = "行政区域ID")
    private String regionId;

    @ApiModelProperty(name = "countryId" , value = "国ID")
    ...
    @ApiModelProperty(name = "stockHouseId" , value = "库区ID")
