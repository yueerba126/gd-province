...
/**
 * 储备计划管理-储备规模调整记录 plan_reserve_scale_log
 *
 * @author fuql
 * @date 2023-05-17
 */
@ApiModel(description = "储备计划管理-储备规模调整记录")
@Data
@ToString
@NoArgsConstructor
@AllArgsConstructor
@Accessors(chain = true)
@TableName("plan_reserve_scale_log")
public class PlanReserveScaleLog extends BaseFiledEntity implements Serializable {
    ...
    @ApiModelProperty(value = "调整后粮食储备规模数量（万吨）")
    private BigDecimal adjustGrainAmount;

    @ApiModelProperty(value = "调整后油储备规模数量（万吨）")
    private BigDecimal adjustOilAmount;
