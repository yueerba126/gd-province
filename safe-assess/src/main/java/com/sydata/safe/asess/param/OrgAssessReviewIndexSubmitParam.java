...
@ApiModel(description = "部门自评指标提交参数")
public class OrgAssessReviewIndexSubmitParam implements Serializable {

    @NotBlank(message = "部门自评指标ID不能为空")
    ...
    @JsonIgnore
    @ApiModelProperty(value = "部门考核指标ID", hidden = true)
