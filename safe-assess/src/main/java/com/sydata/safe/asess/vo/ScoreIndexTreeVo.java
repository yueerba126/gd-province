...
/**
 * @author lzq
 * @description 粮食安全考核-考核评分指标树形VO
 * @date 2023/4/3 16:36
 */
@ApiModel(description = "粮食安全考核-考核评分指标树形VO")
@Data
@ToString
@NoArgsConstructor
@AllArgsConstructor
@Accessors(chain = true)
public class ScoreIndexTreeVo extends ScoreIndex implements Serializable {
    ...
    private List<ScoreIndexTreeVo> child;
}
