...
/**
 * 粮食安全考核-部门自评对象 safe_assess_org_assess_review
 *
 * @author system
 * @date 2023-02-20
 */
@ApiModel(description = "粮食安全考核-部门自评")
@Data
@ToString
@NoArgsConstructor
@AllArgsConstructor
@Accessors(chain = true)
@TableName("safe_assess_org_assess_review")
public class OrgAssessReview implements Serializable {
    ...
    private String orgAssessDeptId;
    ...
    @ApiModelProperty(value = "状态：待自评、已自评、已退回")
    ...
    @ApiModelProperty(value = "已自评牵头指标数")
    private Integer leadFinishCount;
    ...
    @ApiModelProperty(value = "已自评配合指标数")
    private Integer cooperateFinishCount;
