...
/**
 * 粮食安全考核-部门考核指标对象 safe_assess_org_assess_dept_index
 *
 * @author system
 * @date 2023-02-18
 */
@ApiModel(description = "粮食安全考核-部门考核指标")
@Data
@ToString
@NoArgsConstructor
@AllArgsConstructor
@Accessors(chain = true)
@TableName("safe_assess_org_assess_dept_index")
public class OrgAssessDeptIndex implements Serializable {
