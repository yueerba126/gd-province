...
@ApiModel(description = "考核评分指标考核参数")
public class ScoreIndexAssessParam implements Serializable {
    ...
    @JsonIgnore
    @ApiModelProperty(value = "考核评审指标ID", hidden = true)
