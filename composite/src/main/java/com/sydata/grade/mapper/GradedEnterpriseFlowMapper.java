/**
 * @filename:GradedEnterpriseFlowDao 2023年05月24日
...
/**   
 * @Description:TODO(等级粮库评定管理-企业申报流程表数据访问层)
 *
 * @version: V1.0
 * @author: lzq
 * 
...
public interface GradedEnterpriseFlowMapper extends BaseMapper<GradedEnterpriseFlow> {
