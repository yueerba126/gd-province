/**
 * @filename:DataBindGradedEnterpriseProcess 2023年05月22日
...
/**
 * @Description:TODO(等级粮库评定管理-企业申报审核详情-数据绑定)
 *
 * @version: V1.0
 * @author: lzq
 *
...
@DataBindFieldConfig
public @interface DataBindGradedEnterpriseProcess {
    /**
     * 说明请看 {@link DataBindFieldConfig#sourceField}.
     */
    @AliasFor(annotation = DataBindFieldConfig.class)
    String sourceField() default "#gradedEnterpriseProcessId";
