/**
 * @filename:DataBindGradedExpertManage 2023年05月25日
...
/**   
 * @Description:TODO(等级粮库评定管理-专家管理-数据绑定)
 * 
 * @version: V1.0
 * @author: lzq
 * 
...
@DataBindFieldConfig
public @interface DataBindGradedExpertManage {
    /**
    * 说明请看 {@link DataBindFieldConfig#sourceField}.
    */
    @AliasFor(annotation = DataBindFieldConfig.class)
    String sourceField() default "#gradedExpertManageId";
