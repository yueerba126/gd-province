/**
 * @filename:DataBindGradedEnterpriseMaterial 2023年05月22日
...
/**
 * @Description:TODO(等级粮库评定管理-企业申报证明材料-数据绑定)
 *
 * @version: V1.0
 * @author: lzq
 *
...
@DataBindFieldConfig
public @interface DataBindGradedEnterpriseMaterial {
    /**
     * 说明请看 {@link DataBindFieldConfig#sourceField}.
     */
    @AliasFor(annotation = DataBindFieldConfig.class)
    String sourceField() default "#gradedEnterpriseMaterialId";
