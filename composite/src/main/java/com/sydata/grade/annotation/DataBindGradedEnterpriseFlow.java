/**
 * @filename:DataBindGradedEnterpriseFlow 2023年05月24日
...
/**   
 * @Description:TODO(等级粮库评定管理-企业申报流程表-数据绑定)
 * 
 * @version: V1.0
 * @author: lzq
 * 
...
@DataBindFieldConfig
public @interface DataBindGradedEnterpriseFlow {
    /**
    * 说明请看 {@link DataBindFieldConfig#sourceField}.
    */
    @AliasFor(annotation = DataBindFieldConfig.class)
    String sourceField() default "#gradedEnterpriseFlowId";
