/**
 * @filename:DataBindGradedGrainDepotStandard 2023年05月17日
...
/**
 * @Description:TODO(等级粮库评定管理-等级粮库评定标准-数据绑定)
 *
 * @version: V1.0
 * @author: lzq
 *
...
@DataBindFieldConfig
public @interface DataBindGradedGrainDepotStandard {
    /**
     * 说明请看 {@link DataBindFieldConfig#sourceField}.
     */
    @AliasFor(annotation = DataBindFieldConfig.class)
    String sourceField() default "#scoringMethodId";
     ...
     */
    @AliasFor(annotation = DataBindFieldConfig.class)
    String dataValue() default "#scoringMethod";
