...
@TableName("apparitor_personnel")
@ApiModel(value = "ApparitorPersonnel对象", description = "企业人员信息表")
public class ApparitorPersonnel extends BaseFiledEntity implements Serializable {
