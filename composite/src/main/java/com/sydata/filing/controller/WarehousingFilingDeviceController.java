...
public class WarehousingFilingDeviceController {
    ...
    public List<WarehousingFilingDeviceVo> listByMainId(@RequestParam("companyId") String companyId,@RequestParam("stockId") String stockId) {
        return warehousingFilingDeviceService.listByMainId(companyId,stockId);
    }

    @ApiOperation("根据主表ID，删除从表")
    @PostMapping("/deleteByMainId")
    public Boolean deleteByMainId(@RequestParam("companyId") String companyId,@RequestParam("stockId") String stockId) {
        return warehousingFilingDeviceService.deleteByMainId(companyId,stockId);
    }
