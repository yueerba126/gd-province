...
/**
 * 基础信息-仓房信息对象 basis_warehouse
 *
 * @author lzq
 * @date 2022-07-08
 */
@ApiModel(description = "基础信息-仓房信息")
@Data
@ToString
@NoArgsConstructor
@AllArgsConstructor
@Accessors(chain = true)
@TableName("basis_warehouse")
public class Warehouse extends BaseFiledEntity implements Serializable {
